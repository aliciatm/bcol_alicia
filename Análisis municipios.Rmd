...
- PorcentajeTurísticas2021log. el log parece expicar bastante más, pero la original deja de ser significativa. La puedo quitar. Para hacer el log necesito cambiar un municipio con 0% de viviendas turísticas y lo cambio a 0.01%, porque sino no se computa correctamente el logaritmo.
...
independientes <- independientes |> 
    mutate(PorcentajeTurísticas2021 = ifelse(PorcentajeTurísticas2021 == 0, 0.01, PorcentajeTurísticas2021)) |> 

  mutate(PrecioAlquilerM22=PrecioAlquilerM2^2,
         RentaMedia2021_2 = RentaMedia2021^2,
         PorcentajeTurísticas2021log = log(PorcentajeTurísticas2021)) |> 
...
cuando teng aun modelo alternativo compararlo con f test al modelo4 original.
