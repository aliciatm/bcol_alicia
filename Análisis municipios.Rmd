...
set.seed(123)
fit <- kmeans(numeric_data, centers=6, nstart = 100)
fit
...
barplot(scaled_centers[5,], las=2, col="#097969")
...
# Realizar el clustering con K-means en los datos estandarizados
fit <- kmeans(scaled_numeric_data, centers = 6, nstart = 100)
fit
...
independientes <- numeric_data |> 
  select(PropiedadDifMun, ipv2021General, ipv2021Nueva, ipv2021Segunda, ipv2011General, ipv2011Nueva, ipv2011Segunda, RentaMedia2021, PorcentajeJoven2011, PorcentajeJoven2021, PorcentajeJovenDif, PorcentajeVacias2011, PorcentajeVacias2021, PorcentajeSecundarias2011, PorcentajeSecundarias2021, PorcentajeTurísticas2021, PorcentajeEspañola, PorcentajeEuropea, PorcentajeNoEuropea, PrecioHipoteca2021Prov, PrecioHipoteca2011Prov, DifPrecioHipotecaProv, ParoJuvenil2021, ParoJuvenil2011, PorcentajeProtegidas2011, PorcentajeProtegidas2021, ProtegidaDif, PrecioAlquilerM2)
...
independientes <- numeric_data |> 
  select(PropiedadDifMun, ipv2021General, ipv2021Nueva, ipv2021Segunda, ipv2011General, ipv2011Nueva, ipv2011Segunda, RentaMedia2021, PorcentajeJoven2011, PorcentajeJoven2021, PorcentajeJovenDif, PorcentajeVacias2011, PorcentajeVacias2021, PorcentajeSecundarias2011, PorcentajeSecundarias2021, PorcentajeTurísticas2021, PorcentajeEspañola, PorcentajeEuropea, PorcentajeNoEuropea, PrecioHipoteca2021Prov, PrecioHipoteca2011Prov, DifPrecioHipotecaProv, ParoJuvenil2021, ParoJuvenil2011, PorcentajeProtegidas2011, PorcentajeProtegidas2021, ProtegidaDif, PrecioAlquilerM2, Propiedad11Mun, Herencia11Mun, Alquiler11Mun, Otro11Mun)
