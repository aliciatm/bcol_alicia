...
# Juntar con municipios
municipios <- municipios %>%
  full_join(data_imputed_filtrado, by = "cusec") %>%
  mutate(PrecioAlquilerM2 = coalesce(PrecioAlquilerM2.x, PrecioAlquilerM2.y)) %>%
  select(-PrecioAlquilerM2.x, -PrecioAlquilerM2.y)
