...
-   Probabilidad jovenes de compra en 2011

-   Probabilidad de jovenes compra en 2021

-   Probabilidad de jovenes alquiler en 2011

-   Probabilidad de jovenes alquiler en 2021
...
Ver si propiedad turistica es relevante para la diferencia de menos propiedad en x provincias/CCAA (?)
```{r}

turismo <- turismo |> 
  select(CPRO, PorcentajeTuristicasProvincias)

jovnes_total

modelo <- lm(PropiedadDifProv ~ , data = jovenes_total)
