...
## Nacionalidad y viviendas secundarias

No es posible saber la nacionalidad de las personas propietarias de las viviendas secundarias porque en el censo sólo aparecen las personas en viviendas principales. Hubiera sido útil para distinguir perfiles entre propietarios de viviendas secundarias en la costa y en otras CCAA, porque por lo leído en la bibliografía parece que éstos propietarios tienden a ser turistas europeos.

```{r}
table(microdatos2021_rec$NACIONALIDAD, microdatos2021_rec$TENEN_VIV)
```
